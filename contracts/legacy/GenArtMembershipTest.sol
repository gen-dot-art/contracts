 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract GenArtMembershipTest is
    Ownable,
    ERC165,
    IERC721,
    IERC721Metadata,
    IERC721Enumerable
{
    ...
    uint256 MEMBERSHIP_PRICE = 1000000000000; // 0.000001 ETH
    uint256 MEMBERSHIP_GOLD_PRICE = 5000000000000; // 0.000005 ETH
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = GenArtMembershipTest.ownerOf(tokenId);
        require(to != owner, "approval to current owner");
        address sender = _msgSender();
        require(
            sender == owner || GenArtMembershipTest.isApprovedForAll(owner, sender),
        ...
        returns (bool)
    {
        ...
        return (spender == owner ||
            ...
            GenArtMembershipTest.isApprovedForAll(owner, spender));
    }
    ...
    function _transfer(
        ...
        require(
            GenArtMembershipTest.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(GenArtMembershipTest.ownerOf(tokenId), to, tokenId); // internal owner
    }
}